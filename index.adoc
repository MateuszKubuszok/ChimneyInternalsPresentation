...
[source, scala]
--
val fooBarR = new Transformer[FooR, BarR] {
  def transform(foor$1: FooR): BarR = new BarR(
    foor$1.a,
    td$1.runtimeData(0)
        .asInstanceOf[FooR => Option[BarR]]
        .apply(foor$1)
  )
}
--
...
=== Are there differences in macros?
...
TODO some example from e.g. product macros 0.2 vs 0.7
